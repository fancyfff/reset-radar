...
PLATFORMS = {
    ...
    "antigravity": {
        "name": "Antigravity",
        "icon": "🛰️",
        "logo": "assets/antigravity.svg",
        "github_repo": "google-antigravity/antigravity-cli",
        "status_base": "",
        "status_api": "",
        "resets": [
            {"time": "2026-08-22T12:00:00Z", "reason": bi("Regular cycle reset", "常规周期重置"), "is_extra": False},
            {"time": "2026-08-20T12:05:00Z", "reason": bi("Regular cycle reset", "常规周期重置"), "is_extra": False},
            {"time": "2026-08-18T11:55:00Z", "reason": bi("Regular cycle reset", "常规周期重置"), "is_extra": False},
        ],
        "weekly_quota": None,
        "signals": [],
    },
    "zcode": {
        "name": "Z.AI Code",
        "icon": "🔷",
        "logo": "assets/zcode.svg",
        "hidden": True,
        "github_repo": "zai-org/GLM-5",
        "status_base": "",
        "status_api": "",
        "resets": [
            {"time": "2026-08-22T02:00:00Z", "reason": bi("Regular cycle reset", "常规周期重置"), "is_extra": False},
            {"time": "2026-08-20T02:00:00Z", "reason": bi("Regular cycle reset", "常规周期重置"), "is_extra": False},
            {"time": "2026-08-18T02:00:00Z", "reason": bi("Regular cycle reset", "常规周期重置"), "is_extra": False},
        ],
        "weekly_quota": None,
        "signals": [],
    },
    "qwen_code": {
        "name": "Qwen Code",
        "icon": "⚛️",
        "logo": "assets/qwen-code.svg",
        "github_repo": "QwenLM/qwen-code",
        "status_base": "",
        "status_api": "",
        "resets": [
            {"time": "2026-08-22T16:00:00Z", "reason": bi("Regular cycle reset", "常规周期重置"), "is_extra": False},
            {"time": "2026-08-20T16:10:00Z", "reason": bi("Regular cycle reset", "常规周期重置"), "is_extra": False},
            {"time": "2026-08-18T15:55:00Z", "reason": bi("Regular cycle reset", "常规周期重置"), "is_extra": False},
        ],
        "weekly_quota": None,
        "signals": [],
    },
...
SERVICE_STATUS = [
    ...
    },
    {
        ...
        "source": bi("Google Antigravity official status", "Google Antigravity 官方状态"),
        "status": "operational",
        "summary": bi("All systems operational", "全部系统运行正常"),
        "events": [],
    },
    {
        "platform_id": "zcode",
        "platform_name": "Z.AI Code",
        "source": bi("Z.AI official status", "Z.AI 官方状态"),
        "status": "operational",
        "summary": bi("All systems operational", "全部系统运行正常"),
        "events": [],
    },
    {
        "platform_id": "qwen_code",
        "platform_name": "Qwen Code",
        "source": bi("Qwen official status", "Qwen 官方状态"),
        "status": "operational",
        "summary": bi("All systems operational", "全部系统运行正常"),
        "events": [],
    },
